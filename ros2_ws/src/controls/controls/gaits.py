...
class WalkBackward(Gait):
    ...
    def getPos(self, time):
        ...
        return [self.positionsLeft[self.findTimeStep(tFL)],
                self.positionsRight[self.findTimeStep(tFR)],
                self.positionsRight[self.findTimeStep(tBR)],
                self.positionsLeft[self.findTimeStep(tBL)]]
