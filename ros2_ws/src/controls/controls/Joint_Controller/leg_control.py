...
def main(args=None):
    ...
    while True:
        ...
        if joint_positions is None:
            continue
        # don't power the motors until the first message is received
        
        # if (cycle % 10000 == 0):
        #     joint_pos_sub.get_logger().info(f"receiving positions: {joint_positions[3]}, {joint_positions[7]}, {joint_positions[11]}")
